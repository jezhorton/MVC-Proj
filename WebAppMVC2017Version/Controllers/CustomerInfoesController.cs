...
namespace WebAppMVC2017Version
{
    public class CustomerInfoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,OrderNumber")] CustomerInfo customerInfo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FirstName,LastName,OrderNumber")] CustomerInfo customerInfo)
        {
            if (ModelState.IsValid)
            {
